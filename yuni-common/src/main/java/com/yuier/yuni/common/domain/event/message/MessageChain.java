...
import com.yuier.yuni.common.domain.event.message.data.ImageData;
import com.yuier.yuni.common.domain.event.message.data.ReplyData;
import com.yuier.yuni.common.domain.event.message.data.TextData;
import com.yuier.yuni.common.domain.event.message.data.AtData;
